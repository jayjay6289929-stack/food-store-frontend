...
import { ShoppingCart, ArrowRight, Truck, Leaf, ShieldCheck, Clock } from "lucide-react";
            ...
            {[
              {
                ...
                desc: "We work directly with local farmers across Nigeria, ensuring fair prices and maximum freshness.",
                icon: "🌾"
              },
              {
                title: "Zero Preservatives",
                desc: "All our ingredients are 100% natural with no artificial additives or preservatives.",
                icon: "🍃"
              },
              {
                title: "Cultural Authenticity",
                desc: "Traditional ingredients sourced from the regions they're originally grown, preserving authentic flavors.",
                icon: "🇳🇬"
              }
            ].map((item, i) => (
              <motion.div
